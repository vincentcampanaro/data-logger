...
bmp280.sea_level_pressure = 1001.35
...
#    print("Altitude: {:.1f} m".format(bmp280.altitude))
    print(("Barometric pressure:", bmp280.pressure) + ("{:.2f} F".format(bmp280.temperature * 1.8 + 32)) + ("{:.1f} %".format(sht31d.relative_humidity)) + (normalized_rms(samples)))
